...
{
    PNODE head = NULL;
    int iChoice = 0;            //Accept Choice from user 
    int iValue = 0;             //Accept Data from user
    int iPos = 0;               //Accept position incase of  InsertAtPos() and DeleteAtPos()
    int iRet = 0;               //Accept return value of Count Function
    ...
    while(1)
    {
        ...
        {
            iRet = Count(head);
            printf("Number of lements in the Linked List are : %d\n",iRet);
        }
