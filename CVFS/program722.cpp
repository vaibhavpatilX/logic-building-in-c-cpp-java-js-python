...
void DisplayHelp()
{
    ...
    printf("stat : It is used to display stattistical information about the file\n");
...
//  Description :       It is used to display the information about the file
//  Input :             It accepts the file name
//  Output :            It returns the nothing
//  Author :            Vaibhav Patil
//  Date :              15/08/2025
...
//  Description :       It is used to display about the given files 
//  Input :             It accepts the file name
//  Output :            It returns the nothing
//  Author :            Vaibhav Patil
//  Date :              15/08/2025
                ...
                )
{
    ...
    while(temp != NULL)
    {
        ...
        {
            printf("------------------ Statistical informationof file ----------------------\n");
            printf("File name : %s\n",temp -> FileName);
